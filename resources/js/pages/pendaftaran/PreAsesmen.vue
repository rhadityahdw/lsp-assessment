...
>
  <RadioGroup
    :model-value="formStore.answers[question.id] === true ? 'true' : formStore.answers[question.id] === false ? 'false' : null"
    @update:model-value="val => handleAnswer(question.id, val === 'true')"
    class="space-y-4"
  >
