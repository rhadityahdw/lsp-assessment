...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: `Edit Unit - ${props.unit.name}`,
        href: route('units.edit', props.unit.id),
    },
];
...
const form = useForm({
    ...
    pre_assessments: props.unit.pre_assessments.map(pa => ({
        id: pa.id,
        question: pa.question,
        expected_answer: pa.expected_answer,
    })),
});

const addPreAssessment = () => {
    form.pre_assessments.push({
        id: props.unit.pre_assessments.length + 1, 
        question: '',
        expected_answer: 'yes',
    });
};
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        <CardContent class="space-y-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div v-for="(assessment, index) in form.pre_assessments" :key="index" class="border rounded-md p-4 space-y-4">
                                    <div class="flex justify-between items-center">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <Select v-model="assessment.expected_answer">
